  ...
  return (
    <main className="flex flex-1 w-full h-full p-4">
      <div className="flex flex-col gap-4 flex-1 w-full min-h-[400px] h-full text-center justify-center items-center">
        <p className="semi-bold tracking-tighter leading-normal text-4xl max-w-[800px] gap-2">
          Effortlessly Generate Custom Form Code for{" "}
          <strong>React and HTML</strong>
        </p>
      </div>
    </main>
  );
